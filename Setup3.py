...
def main(window):
    ...
    fire1.on()
    fire2 = Fire(800, HEIGHT - block_size - 64, 16, 32)
    fire2.off()
    fire3 = Fire(2500, HEIGHT - block_size - 64, 16, 32)
    fire3.on()
    ...
    objects = [*floor, 
               ...
               Block(100, HEIGHT - block_size * 2, block_size),
               Block(block_size * 3, HEIGHT - block_size * 4, block_size), fire1,
               Block(block_size * 4, HEIGHT - block_size * 4, block_size),
               Block(block_size * 5, HEIGHT - block_size * 4, block_size),
               Block(block_size * 8, HEIGHT - block_size * 3, block_size),fire2,
               ...
               Block(block_size * 25, HEIGHT - block_size * 6, block_size),fire3,
